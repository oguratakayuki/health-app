import { IIngredientService, CreateIngredientData } from '@/domain/interfaces/IIngredientService';
import { Ingredient, IngredientWithRelations } from '@/domain/entities/Ingredient';
...
async updateIngredient(id: bigint, ingredientData: Partial<Ingredient>): Promise<Ingredient> {
    ...
    if (ingredientData.originalName !== undefined) {
      updateData.originalName = this.normalizeString(ingredientData.originalName);
    }
