...
describe("NutrientService", () => {
  ...
  describe("createNutrient", () => {
    it("should create nutrient successfully", async () => {
      ...
      const createdNutrient = createTestNutrient({
        id: "2",
        name: "New Nutrient",
      });
    ...
    it("should throw error when name is empty", async () => {
      ...
      await expect(nutrientService.createNutrient(createInput)).rejects.toThrow(
  ...
  describe("updateNutrient", () => {
    const existingNutrient = createTestNutrient({
      id: "1",
      name: "Old Nutrient",
    });
    ...
    it("should throw error when nutrient not found", async () => {
      ...
      await expect(
        nutrientService.updateNutrient("999", updateInput),
  ...
  describe("deleteNutrient", () => {
    ...
    it("should throw error when nutrient not found", async () => {
      ...
      await expect(nutrientService.deleteNutrient("999")).rejects.toThrow(
        "Nutrient with id 999 not found",
      );
  ...
  describe("getNutrientsByParent", () => {
    it("should return nutrients by parent ID", async () => {
      const mockNutrients = [
        createTestNutrient({
          id: "2",
          name: "Child Nutrient 1",
          parentId: "1",
        }),
        createTestNutrient({
          id: "3",
          name: "Child Nutrient 2",
          parentId: "1",
        }),
      ];
