...
describe("IngredientService", () => {
  ...
  describe("createIngredient", () => {
    ...
    it("should throw error when name is empty", async () => {
      ...
      // 実行 & 検証
      await expect(
        ingredientService.createIngredient(createData),
  ...
  describe("updateIngredient", () => {
    ...
    beforeEach(() => {
      ...
      mockRepo.findById.mockResolvedValue(
        createTestIngredientWithRelations(existingIngredient),
      );
    });
    ...
    it("should throw error when new name is empty", async () => {
      ...
      // 実行 & 検証
      await expect(
        ingredientService.updateIngredient(BigInt(1), updateData),
  ...
  describe("deleteIngredient", () => {
    ...
    it("should throw error when deletion fails", async () => {
      ...
      // 実行 & 検証
      await expect(
        ingredientService.deleteIngredient(BigInt(1)),
