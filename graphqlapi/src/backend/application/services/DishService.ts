...
export class DishService implements IDishService {
  ...
  async getDish(id: string): Promise<DishWithIngredients | null> {
    try {
      ...
      throw new Error(
        `Failed to get dish: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  }
  ...
  async getAllDishes(): Promise<Dish[]> {
    try {
      ...
      throw new Error(
        `Failed to get dishes: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  }
  ...
  async getDishesWithIngredients(): Promise<DishWithIngredients[]> {
    try {
      ...
      throw new Error(
        `Failed to get dishes with ingredients: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  }
  ...
  async createDish(input: CreateDishInput): Promise<Dish> {
    try {
      ...
      throw new Error(
        `Failed to create dish: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  }
  ...
  async updateDish(id: string, input: UpdateDishInput): Promise<Dish> {
    try {
      ...
      throw new Error(
        `Failed to update dish: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  }
  ...
  async deleteDish(id: string): Promise<boolean> {
    try {
      ...
      throw new Error(
        `Failed to delete dish: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  }
  ...
  async searchDishesByName(name: string): Promise<Dish[]> {
    try {
      ...
      throw new Error(
        `Failed to search dishes: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  }
  ...
  async getDishesCount(): Promise<number> {
    try {
      ...
      throw new Error(
        `Failed to get dishes count: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  }
}
