...
} from '@/domain/entities/DishIngredient';
...
export interface IDishIngredientRepository {
  ...
  update(id: string, contentQuantity: number, contentUnit: string): Promise<DishIngredient>;
  delete(id: string): Promise<boolean>;
  createMany(dishIngredients: CreateDishIngredientInput[]): Promise<DishIngredient[]>;
