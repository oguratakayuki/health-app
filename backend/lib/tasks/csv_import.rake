...
namespace :csv_import do
  ...
  task :nutrients_intake_standards, [:file_path] => :environment do |_t, args|
  ...
  desc 'nutrientsをcsvファイルからimportする'
  task :nutrients, [:file_path] => :environment do |_t, args|
  ...
  task :ingredients_nutrients, [:file_path] => :environment do |_t, args|
